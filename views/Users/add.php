<div class="col-sm-4">
    ...
    <form role="form" action="index.php?page=Users&action=add" method="post">
        ...
        <? php
        if (isset($data['birth-year'])): ; ?>
        yearElement.selectedIndex = currentYear - <? php echo(int) $data['birth-year'] ?> ; <? php endif; ?>

        <? php
        if (isset($data['birth-month'])): ; ?>
        monthElement.selectedIndex = <? php echo(int) $data['birth-month'] - 1 ?> ; <? php endif; ?>

        change();

        <? php
        if (isset($data['birth-day'])): ; ?>
        dayElement.selectedIndex = <? php echo(int) $data['birth-day'] - 1 ?> ; <? php endif; ?>
